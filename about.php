...
<body>
    ...
    <main style="background-color:black;">
        ...
        <!-- Menu start -->
        <section id="menu" class="pb-3" style="margin-bottom:1px;">
            <div class="menu-container py-2">
                <div class="py-1 d-flex justify-content-center">
                    <p class="para-above">About Us</p>
                </div>
            </div>
            <div class="container about-content">
                <p class="about-text">Welcome to our fast-food restaurant! We are a family-owned establishment that has been serving delicious meals. Our passion for food and commitment to exceptional service make us a favorite dining spot for locals
                    and visitors alike.</p>
                    <p class="about-text">Come and experience our carefully crafted menu, which features a variety of dishes prepared with fresh,
                    locally sourced ingredients. Our team of talented chefs and friendly staff work together to create a memorable
                    dining experience for our guests.</p>
                    <p class="about-text">At Cheesy Hunger, we strive to provide a warm and inviting atmosphere where you can enjoy a fantastic meal
                    with friends and loved ones. We look forward to serving you soon!</p>
            </div>
        </section>
        <!-- Menu end -->
